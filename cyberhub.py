...
try:
    def update():
        ...
        if not nouse:
            if "Already up to date" in use.decode():
                ...
                print(use.decode())
                print("\u001b[32m[+] CyberHub is UPDATED To Latest Version")
                try:
                    subprocess.run('cyberhub',shell=True, check = True)
                except Exception as err:
                    os.system("python3 cyberhub.py")
                exit()
            else:
    ...
    def starting():
        parser = argparse.ArgumentParser(
            description="CyberHub is a complete resource hub for Cyber Security Community. Our aim is to make this tool an 1 stop solution for all the Hackers out there to get resources of various topics in Cyber Security. We will keep updating this tool & adding new & updated resources on the go.",
        )
        ...
        if args.tools:
            ...
            run_on_browser.main("https://github.com/ypraveennaidu/CyberHub--Cybersecurity-Roadmap/blob/ef0b1d37d340f7f60d427ae81c1778246db3d3e1/cheatsheet.md")
    ...
    def main():
        ...
        if "root" not in there:
            try:
                subprocess.run('sudo cyberhub',shell=True, check = True)
            except Exception as err:
                os.system("sudo python3 cyberhub.py")
            # os.system("sudo cyberhub")
            exit()
        while True:
            os.system("clear")
            banner.main()
            ...
            if option=="1":
                ...
                run_on_browser.main("https://github.com/ypraveennaidu/CyberHub--Cybersecurity-Roadmap.git")
            elif option == "5":
                run_on_browser.main("https://github.com/ypraveennaidu/CyberHub--Cybersecurity-Roadmap/blob/ef0b1d37d340f7f60d427ae81c1778246db3d3e1/Writeups.md")
            elif option=="6":
                os.system("clear")
